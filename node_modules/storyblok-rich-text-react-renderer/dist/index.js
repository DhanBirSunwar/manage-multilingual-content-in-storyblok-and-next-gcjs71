...
const emojiNodeResolver = function (_, attrs) {
  ...
  if (attrs.emoji || !attrs.fallbackImage) {
    return React__default["default"].createElement('span', props, attrs.emoji);
  } else {
    const fallbackProps = {
    ...
    const fallback = React__default["default"].createElement('img', fallbackProps);
    return React__default["default"].createElement('span', props, fallback);
  }
};
...
const styledMarkResolver = function (children, attrs) {
  ...
  return React__default["default"].createElement('span', props, children);
};
...
exports.MARK_ANCHOR = MARK_ANCHOR;
